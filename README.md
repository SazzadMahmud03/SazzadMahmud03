...
<strong>Comfortable with: HTML5, CSS3, JavaScript, Bootstrap, Tailwind, React, React Router Dom, React Hook Form, Axios, Node JS, MongoDB, Express JS etc.</strong>

<strong>Familiar with: TypeScript, Material UI, Google Map, JWT Token etc.</strong>

<strong>Tools: Git, Github, VS Code, Firebase, Netlify, Heroku, Figma, Canva, CMD, Chrome Dev Tool, MS Office etc.</strong>
